...
public class Calculate_Formula extends CustomJavaAction<java.math.BigDecimal>
{
	...
	{
		this.NumberList = new java.util.ArrayList<dynamicform.proxies.Number>();
		if (__NumberList != null)
			for (IMendixObject __NumberListElement : __NumberList)
				this.NumberList.add(dynamicform.proxies.Number.initialize(getContext(), __NumberListElement));
