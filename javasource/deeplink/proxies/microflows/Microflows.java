...
public class Microflows
{
	...
	public static void create_ReviewForms(IContext context)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		Core.microflowCall("DeepLink.Create_ReviewForms").withParams(params).execute(context);
	}
	...
	public static void sub_CreateReviewQuestions(IContext context, java.lang.Long _int)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		params.put("int", _int);
		Core.microflowCall("DeepLink.Sub_CreateReviewQuestions").withParams(params).execute(context);
	}
