...
public class WorkflowContext
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("DynamicForm.Grant", mendixObject.getType()))
			return dynamicform.proxies.Grant.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("UGS.GrantSystem", mendixObject.getType()))
			return ugs.proxies.GrantSystem.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("DynamicForm.Template", mendixObject.getType()))
