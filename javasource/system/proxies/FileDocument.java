...
public class FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("UGS.Aggrement_", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("DynamicForm.Document", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("UGS.Printout", mendixObject.getType()))
			return ugs.proxies.Printout.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("UGS.Provider", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("BizzomateTokenReplacer.TokenReplacerFile", mendixObject.getType()))
			return bizzomatetokenreplacer.proxies.TokenReplacerFile.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("UGS.Voucher", mendixObject.getType()))
